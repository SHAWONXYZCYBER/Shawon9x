...
def logo():
    ...
    print(50*'-')
    print(f" {white}{green}[~]{white} Owner     : Shawon sins")
    print(f" {white}{green}[~]{white} Facebook  : prince shawon ")
    print(f" {white}{green}[~]{white} Fucked By : jhonny sins ")
    print(f" {white}{green}[~]{white} Tool      : Multi Brute Force Facebook ")
    print(f" {white}{green}[~]{white} Github    : https://github.com/Sawonxyzcyber)
    print(f" {white}{green}[~]{white} Whatsapp  : No Have ")
